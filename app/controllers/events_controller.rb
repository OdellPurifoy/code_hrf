...
class EventsController < ApplicationController
  ...
  def index
    @events = @lounge.events.order(created_at: :desc)
  end
  ...
  def event_params
    params.require(:event).permit(:name, :event_date, :event_type, :event_description, :event_url, :zoom_code, :rsvp_needed, :maximum_capacity,
